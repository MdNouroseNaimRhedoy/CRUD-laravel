...
<head>
    ...
    <style type="text/tailwindcss">
        @layer utilities {
            ...
            .btn{
                @apply bg-green-400 text-white rounded py-2 px-4
            }
        }
    </style>
                                ...
                                @foreach($posts  as $post)
                                    <tr class="odd:bg-white even:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            ...
                                            <form action="{{route('delete',$post->id)}}" class="inline">
                                                @csrf
                                                @method('delete')
                                                <button class="bg-red-400 rounded py-2 px-4" type="submit">Delete</button>
                                            </form>
